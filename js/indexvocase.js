let storevocase = new Storevocase("Thành Nhân");
...
function add() {
    ...
    let newProduct = new Productvocase(img, name, id, price_old, price_new);
    storevocase.add(newProduct);
    getAll();
...
function showFormEdit(index) {
    let oldProduct = storevocase.getProductByIndex(index);
    ...
    document.getElementById("btn-vocase").innerHTML = `<button onclick="edit(${index})">Lưu</button> `
}
function edit(index) {
    let img = document.getElementById("img").value;
    let name = document.getElementById("name").value;
    ...
    let price_new = document.getElementById("price_new").value; 
    let newProduct = new Productvocase(img, name,id, price_old,price_new);
    storevocase.edit(index, newProduct);
    ...
    document.getElementById("price_old").value = "";
    document.getElementById("price_new").value = "";
     document.getElementById("btn-vocase").innerHTML = `<button onclick="add()">Thêm mới</button> `
}
getAll()
