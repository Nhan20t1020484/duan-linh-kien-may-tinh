...
function getByName() {
    ...
    let list = storeram.getByNameContain(nameSearch);
    let html = ``;
...
function showFormEdit(index) {
    ...
    document.getElementById("btn-ram").innerHTML = `<button onclick="edit(${index})">Lưu</button> `
}
function edit(index) {
    let img = document.getElementById("img").value;
    let name = document.getElementById("name").value;
    ...
    document.getElementById("price_old").value = "";
    document.getElementById("price_new").value = "";
     document.getElementById("btn-ram").innerHTML = `<button onclick="add()">Thêm mới</button> `
}
getAll()
